...
```{r assumptions, echo=FALSE,results='hide',message=FALSE}
par(mfrow=c(1,2))
...
We want to build a classification tree using the 6 predictors in our second lasso reduced model. First, we converted all of the characters to factors.
